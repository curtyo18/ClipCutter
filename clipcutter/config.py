...
LAUGHTER_AUTOCORR_THRESHOLD = 0.45
LAUGHTER_MIN_DURATION_SECONDS = 1.5
LAUGHTER_ENERGY_FLOOR_RATIO = 1.2      # Window mean RMS must exceed this × median
LAUGHTER_CENTROID_FLOOR_RATIO = 1.3     # Window centroid must exceed this × median
LAUGHTER_MFCC_VARIANCE_THRESHOLD = 0.4  # Min frame-to-frame MFCC variance (normalized)
